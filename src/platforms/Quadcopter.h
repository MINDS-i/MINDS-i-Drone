...
#endif
Output_t esc[4] = {Output_t(12 /*CCW TR APM 1*/), Output_t(11 /*CCW BL APM 2*/), Output_t(8 /*CW  TL APM 3*/),
                   Output_t(7 /*CW  BR APM 4*/)};
...
Horizon horizon(&attPID, &attVel, &attPID, &attVel, &yawPID, &yawVel);
...
void setupSettings() {
    ...
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), &changeInterruptPeriod);
    ...
    index = 1;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { orientation.setAccelGain(g); });
    ...
    index = 2;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { orientation.setMagGain(g); });
    ...
    index = 3;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { attPID.setIdealP(g); });
    ...
    index = 4;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { attPID.setIdealI(g); });
    ...
    index = 5;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { attPID.setIdealD(g); });
    ...
    index = 6;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { attVel.setIdealP(g); });
    ...
    index = 7;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { attVel.setIdealI(g); });
    ...
    index = 8;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { attVel.setIdealD(g); });
    ...
    index = 9;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { yawPID.setIdealP(g); });
    ...
    index = 10;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { yawPID.setIdealI(g); });
    ...
    index = 11;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { yawPID.setIdealD(g); });
    ...
    index = 12;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { yawVel.setIdealP(g); });
    ...
    index = 13;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { yawVel.setIdealI(g); });
    ...
    index = 14;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { yawVel.setIdealD(g); });
    ...
    index = 15;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { throttleCurve.setHoverPoint(g); });
    ...
    index = 16;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { throttleCurve.setLinearity(g); });
    ...
    index = 17;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { YawTargetSlewRate = g; });
    ...
    index = 18;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { AltitudeTargetSlewRate = g; });
    ...
    index = 19;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { altitude.setBarometerGain(g); });
    ...
    index = 20;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { altitude.setVelocityGain(g); });
    ...
    index = 21;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { altitudeHold.setResponseFactor(g); });
    ...
    index = 22;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { altitudeHold.setVelocityFactor(g); });
    ...
    index = 23;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { altitudeHold.setIntegralFactor(g); });
    ...
    index = 24;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { position.setIdealP(g); });
    ...
    index = 25;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { position.setIdealI(g); });
    ...
    index = 26;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { position.setIdealD(g); });
    ...
    index = 28;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { positionHold.setVelocityScale(g); });
    ...
    index = 29;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { power.setLowVolt(g); });
    ...
    index = 30;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { magneticDeclination = toRad(g); });
    ...
    index = 31;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { gpsAssist = (g != 0.0f); });
    ...
    index = 32;
    settings.attach(index, pgm_read_float_near(&settingsData[index][0]), pgm_read_float_near(&settingsData[index][1]),
                    pgm_read_float_near(&settingsData[index][2]), [](float g) { autolandDescentRate = g; });
}
} // namespace Platform
#endif