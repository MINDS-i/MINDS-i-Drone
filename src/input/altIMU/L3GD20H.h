...
class L3GD20H : public STMtwiDev {
  ...
  public:
    L3GD20H() : STMtwiDev(0x6B, true), LPfac(.9999) {}
    L3GD20H(float LP) : STMtwiDev(0x6B, true), LPfac(LP) {}
    ~L3GD20H() { end(); }
    void begin();
    void end();
...
void L3GD20H::end() { this->write(CTRL1, 0); }
Sensor::Status L3GD20H::status() { return Sensor::OK; }
...
void L3GD20H::getRawGyro(int16_t* buf) {
    uint8_t data[6];
