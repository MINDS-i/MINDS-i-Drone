...
namespace Protocol {
uint16_t fletcher16(uint8_t const* data, int length) { return fletcher16_resume(data, length, 0xFFFF); }
...
messageType getMessageType(uint8_t label) { return (messageType)(label & 0x0F); }
